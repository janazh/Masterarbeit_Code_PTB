...
This script generates and plots the motion-corrected T1 map for the volunteer MID182 when using an head-feet radar signal.
The filepath to the measurement data (.h5 file) and the radar shifts file need to be assigned in the beginning.
