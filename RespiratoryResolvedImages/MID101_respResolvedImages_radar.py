...
This script generates and plots the respiratory-resolved images for the volunteer MID101 when using the head-feet radar signal.
The filepath to the measurement data (.h5 file) and to the radar shifts text file need to be assigned in the beginning.
