...
This script generates the breathhold T1 map for the volunteer MID122.
The measurement data for the breathhold is MID123 (the number is the number of the original data plus 1).
...
praw = "/data/zhang18/MRI_Data/Data_PTBMR04_008/meas_MID123_T1resp_13x13x8_FID74163.h5"
rec_im = []
