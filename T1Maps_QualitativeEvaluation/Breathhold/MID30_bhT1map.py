...
This script generates the breathhold T1 map for the volunteer MID29.
The measurement data for the breathhold is MID30 (the number is the number of the original data plus 1).
...
praw = "/data/zhang18/MRI_Data/Data_PTBMR04_009/meas_MID30_T1resp_13x13x8_FID74728.h5"
rec_im = []
