...
This script generates the breathhold T1 map for the volunteer MID101.
The measurement data for the breathhold is MID102 (the number is the number of the original data plus 1).
...
praw = "/data/zhang18/MRI_Data/Data_PTBMR04_010/meas_MID102_T1resp_13x13x8_FID74800.h5"
rec_im = []
