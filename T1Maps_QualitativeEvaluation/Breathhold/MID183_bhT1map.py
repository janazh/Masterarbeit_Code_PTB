...
This script generates the breathhold T1 map for the volunteer MID182.
The measurement data for the breathhold is MID183 (the number is the number of the original data plus 1).
...
praw = "/data/zhang18/MRI_Data/Data_PTBMR04_011/meas_MID183_T1resp_13x13x8_FID74881.h5"
rec_im = []
