...
In this script, the image-based self-navigator is compared with the head-feet radar signal for volunteer MID29.
...
filepath_radar = "/data/zhang18/MRI_Data/Data_PTBMR04_009/Radar_trashift/trashift_29.txt"
