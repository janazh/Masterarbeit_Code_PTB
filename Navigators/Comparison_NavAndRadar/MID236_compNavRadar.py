...
In this script, the image-based self-navigator is compared with the head-feet radar signal for volunteer MID236.
...
filepath_radar = "/data/zhang18/MRI_Data/Data_PTBMR04_012/Radar_trashift/trashift_236.txt"
