...
In this script, the image-based self-navigator is compared with the head-feet radar signal for volunteer MID122.
...
filepath_radar = "/data/zhang18/MRI_Data/Data_PTBMR04_008/Radar/trashift_122.txt"
