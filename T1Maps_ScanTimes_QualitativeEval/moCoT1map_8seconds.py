...
This script generates the motion-corrected T1 map for the volunteer MID101. For the estimation of the motion fields,
the 16 seconds scan is used. For the final fitting for the T1 map, the scan time is reduced to 8 seconds (number of lines
is 1596).
